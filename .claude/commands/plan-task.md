...
Việc cần làm:
1. Đọc requirements và ADR liên quan trong `projects/<project-slug>/docs/`.
...
4. Ghi vào `projects/<project-slug>/docs/tasks/<feature-slug>.md`, dựa theo `templates/task-breakdown.md`.

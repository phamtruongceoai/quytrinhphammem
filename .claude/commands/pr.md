...
3. Ghi vào `projects/<project-slug>/docs/pr/<feature-slug>-<mô-tả-ngắn>.md`, dựa theo `templates/pr-checklist.md`. Một PR không nhất thiết ứng với 1 task — có thể gộp nhiều task, đặt tên theo nội dung PR.

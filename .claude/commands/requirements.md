...
Việc cần làm:
1. Xác định `<project-slug>` (thư mục project trong `projects/`, hỏi người dùng nếu chưa rõ tạo mới hay dùng project có sẵn) và `<feature-slug>` (tên ngắn kebab-case riêng cho tính năng này — khác `<project-slug>` nếu project đã có tính năng khác từ trước, để không ghi đè file cũ).
...
4. Ghi vào `projects/<project-slug>/docs/requirements/<feature-slug>.md`, dựa theo `templates/user-story.md`.
